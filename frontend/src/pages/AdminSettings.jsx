    ...
    <div className="space-y-12 max-w-4xl mx-auto">
      ...
      >
        <div className="space-y-1">
          ...
          <h1 className="text-4xl font-black font-outfit text-white tracking-tight uppercase">Platform Settings</h1>
          <p className="text-slate-500 font-medium tracking-wide">Manage your central command identity and credentials.</p>
        </div>
      </motion.header>
        ...
        <form onSubmit={handleSubmit} className="glass-card p-8 lg:p-10 space-y-8 relative overflow-hidden group">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
            <div className="space-y-2 md:col-span-2 mb-2">
              <label className="text-[10px] font-black text-emerald-500 uppercase tracking-widest ml-1">Administrator Username (Immutable)</label>
          ...
          <div className="pt-6 flex justify-end">
             ...
             >
                ...
                <span className="text-sm uppercase font-black tracking-widest">Save Changes</span>
             </button>
          </div>
        </form>
      </motion.div>
